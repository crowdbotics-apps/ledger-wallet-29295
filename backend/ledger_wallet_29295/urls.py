"""ledger_wallet_29295 URL Configuration
...
admin.site.site_header = "Ledger Wallet"
admin.site.site_title = "Ledger Wallet Admin Portal"
admin.site.index_title = "Ledger Wallet Admin"

# swagger
api_info = openapi.Info(
    title="Ledger Wallet API",
    default_version="v1",
    description="API documentation for Ledger Wallet App",
)
